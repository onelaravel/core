...
namespace One\App\View\Compilers;
...
class BlockDirectiveService
{
    ...
    public function openBlock($expression)
    {
        ...
        if ($isVariable) {
            ...
            $code = "<?php \$__env->startSection('block.' . {$blockName}); ?><!-- [one:block name=\"{$blockName}\" view=\"<?php echo \$__VIEW_PATH__; ?>\" ref=\"<?php echo \$__VIEW_ID__; ?>\"{$attributesStr}] -->";
        } else {
