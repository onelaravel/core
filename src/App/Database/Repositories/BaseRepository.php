...
namespace One\App\Database\Repositories;

use One\Core\Repositories\BaseRepository as CoreBaseRepository;
use Illuminate\Database\Eloquent\Model;

/**
 * Base Repository cho tất cả repositories trong hệ thống
 * 
 * Extends One\Core\Repositories\BaseRepository để tích hợp:
