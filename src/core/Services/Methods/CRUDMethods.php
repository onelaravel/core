...
trait CRUDMethods
{
     ...
     * @var string
     */
    protected $validatorNamespace = 'One\Core\Validators';
     ...
     *
     * @var \One\Core\Repositories\BaseRepository
     */
     ...
     *
     * @param \One\Core\Repositories\BaseRepository $validatorRepository
