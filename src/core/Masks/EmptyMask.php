 ...
 * 
 */
abstract class EmptyMask implements Countable, ArrayAccess, IteratorAggregate, JsonSerializable, Jsonable, Arrayable
{
     ...
     *
     * @param \Illuminate\Support\Collection|\One\Core\Models\Model $relation
     * @param string $mask
     * @return Mask|MaskCollection|\Illuminate\Support\Collection|\One\Core\Models\Model
     */
     ...
     * @return Mask|MaskCollection|\Illuminate\Support\Collection|\One\Core\odels\Model|null
     */
