...
namespace One\Core\Repositories;

use ReflectionClass;

use One\Core\asks\Mask;
use One\Core\Masks\MaskCollection;
use One\Core\Magic\Arr;
use One\Core\Masks\ExampleCollection;
use One\Core\odels\Model;
use One\Core\odels\MongoModel;
use One\Core\odels\SQLModel;
...
trait FilterAction
{
     ...
     * @var string
     */
    protected $maskNamespace = 'One\Core\asks';
     ...
     * @param array $args
     * 
     * @return \One\Core\asks\MaskCollection
     */
     ...
     * @return \One\Core\asks\MaskCollectionExamples
     */
