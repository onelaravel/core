...
class OctaneServiceProvider extends ServiceProvider
{
    ...
    protected function discoverOctaneAwareClasses(): void
    {
        ...
        $this->octaneAwareClasses = [
            // \One\Core\OctaneAwareService::class,
